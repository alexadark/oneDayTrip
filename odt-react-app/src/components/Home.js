    ...
    render() {
        ...
        return <div>
            ...
            <div className="uk-flex uk-flex-center uk-padding">
                <div className={`uk-button uk-button-primary ${this.state.searchAround}`}
                     onClick={() => this.searchAround()}>
            ...
            <div className="uk-container uk-padding">
                {this.state.error ?
                    <h3 className="uk-alert-primary uk-text-center uk-padding-small">{this.state.error}</h3> :
